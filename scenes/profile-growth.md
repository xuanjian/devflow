...
```text
项目事实
  repos/*.md / OpenSpec / runtime/current-work.md / 项目代码 / Notion

学习记录
  person/learning-log.md

画像候选
  person/profile-candidates.md

长期画像
  /Users/xj/Documents/ai-context/person/profile.md
```
...
以下内容不得直接进入 `/Users/xj/Documents/ai-context/person/profile.md`：
...
- 如果更新了 `/Users/xj/Documents/ai-context/person/profile.md`，必须说明晋升原因和证据来源。

## 维护建议

- `person/learning-log.md` 可以较频繁增长。
- `person/profile-candidates.md` 中等频率增长。
- `person/profile.md` 低频更新，只保留稳定、通用、有用的信息。
